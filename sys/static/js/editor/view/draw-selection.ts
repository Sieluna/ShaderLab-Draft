import {EditorSelection, SelectionRange, Extension, Facet, combineConfig, Prec} from "../state/index"
...
// Added to selection rectangles vertical extent to prevent rounding errors from introducing gaps in the rendered content.
