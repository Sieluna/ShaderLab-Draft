import {EditorState, Transaction, StateEffect, StateEffectType, Facet, StateField, Extension, MapMode} from "../state/index"
...
/**
 * Describes a tooltip. Values of this type, when provided through the {@link showTooltip} facet, control the
...
export interface Tooltip {
    ...
    /**
     * Whether the tooltip should be shown above or below the target position. Not guaranteed
     * to be respected for hover tooltips since all hover tooltips for the same range are always
     * positioned together. Defaults to false.
     */
    above?: boolean
    /**
     * Whether the `above` option should be honored when there isn't enough space on that side to
     * show the tooltip inside the viewport. Defaults to false.
     */
    strictSide?: boolean,
