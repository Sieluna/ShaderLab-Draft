import {Line, EditorState, TransactionSpec, StateCommand} from "../state/index"

/** An object of this type can be provided as [language data]{@link languageDataAt} under a `"commentTokens"` property to configure comment syntax for a language. */
