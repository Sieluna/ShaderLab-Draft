import {EditorView, ViewPlugin, Decoration, DecorationSet,
    ...
    PanelConstructor, Panel, showPanel, getPanel} from "../view/index"
import {Text, StateEffect, StateField, Extension, TransactionSpec, Transaction,
    EditorState, Facet, combineConfig, RangeSet, Range} from "../state/index"
import elt from "../utils/crelt"
...
export interface Diagnostic {
    ...
    /**
     * An optional source string indicating where the diagnostic is coming from.
     * You can put the name of your linter here, if applicable.
     */
    source?: string
...
export interface Action {
    ...
    name: string
    /**
     * The function to call when the user activates this action. Is given
     * the diagnostic's _current_ position, which may have changed since
     * the creation of the diagnostic, due to editing.
     */
