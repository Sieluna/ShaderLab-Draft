import {Text, RangeSetBuilder} from "../state/index"
import {EditorView} from "./editorview"
import {ViewUpdate} from "./extension"
import {Decoration, DecorationSet} from "./decoration"

function iterMatches(doc: Text, re: RegExp, from: number, to: number, func: (from: number, to: number, m: RegExpExecArray) => void) {
    re.lastIndex = 0
