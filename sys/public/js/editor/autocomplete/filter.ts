import {codePointAt, codePointSize, fromCodePoint} from "../state/index"

/** Scores are counted from 0 (great match) down to negative numbers, assigning specific penalty values for specific shortcomings. */
const enum Penalty {
