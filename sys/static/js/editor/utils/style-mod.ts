...
export type StyleSpec = { [propOrSelector: string]: string | number | StyleSpec | null }
...
export class StyleModule {
    ...
    constructor(spec: {[selector: string]: StyleSpec}, options?: {finish?(sel: string): string}) {
        ...
        function render(selectors: string[], spec: any, target: any, isKeyframes?: boolean) {
...
let adoptedSet: StyleSet | null = null;

class StyleSet {
    sheet: any; styleTag: any; modules: any;
