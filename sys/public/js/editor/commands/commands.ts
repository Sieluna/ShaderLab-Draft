import {EditorState, StateCommand, EditorSelection, SelectionRange, ChangeSpec, Transaction, CharCategory,
    findClusterBreak, Text, Line, countColumn} from "../state/index"
import {EditorView, Command, Direction, KeyBinding} from "../view/index"
import {syntaxTree, IndentContext, getIndentUnit, indentUnit, indentString, getIndentation,
    matchBrackets} from "../language/index"
import {SyntaxNode, NodeProp} from "../lezer/common/index"
...
export const selectSyntaxLeft: Command = view => extendSel(view, range => moveBySyntax(view.state, range, !ltrAtCursor(view)))
/** Move the selection head over the next syntactic element to the right. */
export const selectSyntaxRight: Command = view => extendSel(view, range => moveBySyntax(view.state, range, ltrAtCursor(view)))
