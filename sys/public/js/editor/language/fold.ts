import {NodeProp, SyntaxNode} from "../lezer/common/index"
import {combineConfig, EditorState, StateEffect, ChangeDesc, Facet, StateField, Extension,
        RangeSet, RangeSetBuilder} from "../state/index"
import {EditorView, BlockInfo, Command, Decoration, DecorationSet, WidgetType, KeyBinding,
        ViewPlugin, ViewUpdate, gutter, GutterMarker} from "../view/index"
...
interface FoldConfig {
    /**
     * A function that creates the DOM element used to indicate the position of folded code.
     * The `onclick` argument is the default click event handler, which toggles folding on
     * the line that holds the element, and should probably be added as an event handler to
     * the returned element.
     *
     * When this option isn't given, the `placeholderText` option will be used to create the
     * placeholder element.
     */
