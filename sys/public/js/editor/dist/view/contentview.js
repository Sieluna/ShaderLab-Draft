...
export function replaceRange(parent, fromI, fromOff, toI, toOff, insert, breakAtStart, openStart, openEnd) {
    let { children } = parent;
...
export function mergeChildrenInto(parent, from, to, insert, openStart, openEnd) {
