import {Tree, SyntaxNode, ChangedRange, TreeFragment, NodeProp, NodeType, Input,
    PartialParse, Parser, IterMode} from "../lezer/common/index"
import type {LRParser, ParserConfig} from "../lezer/lr/index"
import {EditorState, StateField, Transaction, Extension, StateEffect, Facet,
    ChangeDesc, Text, TextIterator} from "../state/index"
...
export class LanguageSupport {
    /**
     * An extension including both the language and its support extensions.
     * (Allowing the object to be used as an extension value itself.)
     */
    extension: Extension
