import {combineConfig, MapMode, Facet, Extension, EditorState, RangeValue, RangeSet, RangeCursor} from "../state/index"
...
interface GutterConfig {
    ...
    /**
     * If line markers depend on additional state, and should be updated when that changes, pass
     * a predicate here that checks whether a given view update might change the line markers.
     */
