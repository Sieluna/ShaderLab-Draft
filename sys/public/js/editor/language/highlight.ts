import {Tree, NodeType} from "../lezer/common/index"
import {Tag, tags, tagHighlighter, Highlighter, highlightTree} from "../lezer/highlight/index"
import {StyleSpec, StyleModule} from "../utils/style-mod"
import {EditorView, ViewPlugin, ViewUpdate, Decoration, DecorationSet} from "../view/index"
import {EditorState, Prec, Facet, Extension, RangeSetBuilder} from "../state/index"
 ...
 */
export function syntaxHighlighting(highlighter: Highlighter, options?: { fallback: boolean }): Extension {
