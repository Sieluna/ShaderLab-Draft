import {EditorView, ViewPlugin, ViewUpdate, Command, Decoration, DecorationSet, runScopeHandlers, KeyBinding,
        PanelConstructor, showPanel, Panel, getPanel} from "../view/index"
import {EditorState, StateField, StateEffect, EditorSelection, StateCommand, Prec, Facet, Extension,
        RangeSetBuilder, Text} from "../state/index"
...
export class SearchQuery {
     ...
     */
    constructor(config: { search: string, caseSensitive?: boolean, literal?: boolean, regexp?: boolean, replace?: string }) {
