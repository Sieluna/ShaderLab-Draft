import {EditorView, KeyBinding} from "../view/index"
import {EditorState, EditorSelection, Transaction, Extension, StateCommand, StateField, StateEffect, MapMode,
        CharCategory, Text, codePointAt, fromCodePoint, codePointSize, RangeSet, RangeValue} from "../state/index"
import {syntaxTree} from "../language/index"

export interface CloseBracketConfig {
    /** The opening brackets to close. */
    brackets?: string[],
    /** Will close in front of default */
    before?: string
}
