...
import {Tree, SyntaxNode, NodeType, NodeProp} from "../lezer/common/index"
...
export interface Config {
    ...
    brackets?: string
    /**
     * The maximum distance to scan for matching brackets. This is only relevant for brackets
     * not encoded in the syntax tree. Defaults to 10 000.
     */
    maxScanDistance?: number
    /**
     * Can be used to configure the way in which brackets are decorated. The default behavior
     * is to add the `cm-matchingBracket` class for matching pairs, and `cm-nonmatchingBracket`
